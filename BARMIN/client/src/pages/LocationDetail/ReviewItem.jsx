...
export default function ReviewItem({ review, locationId }) {
  ...
  async function handleClick(){
    await axios.delete(`http://localhost:3000/locations/${locationId}/reviews/${review._id}`)
      .then(res => {
  ...
  return (
    <div className="card mb-4 border border-gray-300 rounded-lg">
      <div className="p-4">
        ...
        <button onClick={handleClick} className="bg-red-500 text-white py-1 px-3 rounded">
          Delete
        </button>
      </div>
    </div>
